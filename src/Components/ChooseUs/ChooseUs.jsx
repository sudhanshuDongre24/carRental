...
import MainImg from "../../assests/chooseUs/main.png";
import Box1 from "../../assests/chooseUs/icon1.png";
import Box2 from "../../assests/chooseUs/icon2.png";
import Box3 from "../../assests/chooseUs/icon3.png";
      ...
      <section className="choose-section">
        <div className="container">
          <div className="choose-container">
            <img className="choose-container__img" src={MainImg} />
            <div className="text-container">
              ...
              <div className="text-container__right">
                <div className="text-container__right__box">
                  ...
                  <div className="text-container__right__box_text">
